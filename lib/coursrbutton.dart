...
class CoursrButton extends StatelessWidget{
  CourseData courseData;
  List<String> CourseTitle=["Android","IOS","FullStack"];
  List<String> CourseImage=["assets/images/androidd.png","assets/images/ioss.jpg","assets/images/stacck.jpg"];
  List<String> CourseContent=["""Part 1 ( Java SE)
...
•Software development process"""];
  ...
  CoursrButton({required this.courseData});
  @override
      ...
      children: [
        Row(
          children: [
            Expanded(
              child: Image.asset(
                "assets/images/${courseData.CourseImage}",
              ),
            ),
          ],
        ),
            ...
            Expanded(
              child: ElevatedButton(
                onPressed: () {
                  ...
                  arguments:SendDetails(courseData));
                },
                style: ButtonStyle(
                  backgroundColor: MaterialStateProperty.all(
                      Color.fromARGB(255, 24, 26, 41)),
  ...
  CourseArg SendDetails (CourseData cd){
    if(cd.CourseName=="Android Course") {
      return CourseArg(CourseImage: CourseImage[0],
          CourseContent: CourseContent[0],
          CourseTitle: CourseTitle[0]);
    }  else if(cd.CourseName=="IOS Course") {
      return CourseArg(CourseImage: CourseImage[1],
          CourseContent: CourseContent[1],
          CourseTitle: CourseTitle[1]);
    }
    return CourseArg(CourseImage: CourseImage[2],
        CourseContent: CourseContent[2],
